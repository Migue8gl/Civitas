...
public class CivitasJuego {
    ...
    /**
     * Aplica el metodo cancelarHipoteca de Jugador al jugador actual en la
     * propiedad de indice ip
     *
    ...
    /**
     * Comprueba si el jugador actual puede comprar el titulo de la casilla en
     * la que esta
     *
    ...
    /**
     * Aplica el metodo construirCasa de jugador al jugador actual en la
     * propiedad del indice ip
     *
    ...
    /**
     * Aplica el metodo construirHotel de jugador al jugador actual en la
     * propiedad del indice ip
     *
    ...
    /**
     * Cuenta las veces que un jugador ha pasado por la salida y le paga por las
     * veces que ha pasado en el turno actual
     *
     * @param jugadorActual
     */
    ...
    /**
     * Determina si el juego finaliza porque al menos un jugador esta en
     * bancarrota y reordena el vector para obtener el ranking
     *
    ...
    /**
     * Aplica el metodo hipotecar de jugador al jugador acutal en la propiedad
     * del indice ip
     *
    ...
    private void inicializarTablero(MazoSorpresas _mazo) {
        ...
        tablero.añadeCasilla(new CasillaImpuesto(IMPUESTO, "IMPUESTO"));
        ...
        for (int i = 0; i < NUM_PROPIEDADES; i++) {
            tablero.añadeCasilla(new CasillaCalle(titulos.get(i)));
        }
        tablero.añadeJuez();
...
//        }
    ...
    /**
     * Realiza la accion necesaria en caso de que la operacion en curso sea
     * pasar turno o avanzar
     *
